...
namespace Tgc;
[Command(PackageIds.TgcCopyCommand)]
internal sealed class TgcCopyCommand : BaseCommand<TgcCopyCommand>
{
    protected override async Task ExecuteAsync(OleMenuCmdEventArgs e)
    {
        ...
        var psi = new ProcessStartInfo {
            ...
            Arguments = "--mode clipboard --header-format \"file ${index}: ${relpath}\" --separator \"\\n\\n\" --max-kb 1024 --skip-binary true",
        ...
        {
            await VS.Shell.Clipboard.SetTextAsync(stdout);
            await VS.StatusBar.ShowMessageAsync("The Great Combinator: Combined text copied to clipboard");
        }
    }
